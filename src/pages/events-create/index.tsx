...
import {Car, Check, ChevronLeft, ChevronRight, MapPin, Mic, MoveLeft, MoveRight, Music, Plus, Star} from "lucide-react";
                ...
                <div className="grid grid-cols-2 gap-4">
                    {[
                        ...
                        >
                            {dt.label}
                            <div
                                className="size-6 grid place-content-center border border-primary rounded-full bg-background mx-auto">
                        ...
                        <div className="flex flex-col gap-4 mt-2">
                            {selectedFeatures.map((feature) => {
                                ...
                                return (
                                    <div
                                        key={feature}
                                        className="border-b p-2 flex flex-col gap-2 justify-between"
                                    >
                                        ...
                                        <div
                                            className="whitespace-nowrap rounded-md border overflow-x-auto flex flex-row gap-4 -mx-4 pb-2">
                                            {
                                                serviceProviders
                                                    .map(serviceProvider => (
                                                        <Sheet key={serviceProvider?.name}>
                                                            <SheetTrigger>
                                                                <div
                                                                    className={"flex flex-col gap-1 items-center border rounded-md py-2 px-4"}>
                                                                    <div
                                                                    ...
                                                                    <MutedParagraph
                                                                        className={"text-sm"}>{serviceProvider?.name}</MutedParagraph>
                                                                    <div className={"flex items-center gap-1"}>
                                                                        {Array.from({length: 5}, (_, index) => (
                                                                            <Star
                                                                                size={16}
                                                                                fill={index > 4 ? "white" : "#FFCC00"}
                                                                            />
                                                                        ))}
                                                                    </div>
                                                                </div>
                                                            ...
                                                            >
                                                                <SheetHeader>
                                                                    ...
                                                                    <div className={"flex flex-col gap-1 items-center"}>
                                                                        <div
                                                                            className="size-20 roundef-full border-4 border-white">
                                                                            <img src={serviceProvider?.profile} alt=""
                                                                                 className="w-full h-full object-cover rounded-full"/>
                                                                        </div>
                                                                        <Title
                                                                            level={"h2"}>{serviceProvider?.name}</Title>
                                                                    </div>

                                                                    {
                                                                        [
                                                                            {label: "Category", value: target?.label},
                                                                            {label: "Rating", value: 4, kind: "rating"},
                                                                            {
                                                                                label: "Price",
                                                                                value: 2500000,
                                                                                kind: "money"
                                                                            ...
                                                                            if (dt?.kind === "rating") {
                                                                                return (
                                                                                    <div
                                                                                        ...
                                                                                        <MutedParagraph>Category</MutedParagraph>
                                                                                        <div
                                                                                            className={"flex items-center gap-1"}>
                                                                                            {Array.from({length: 5}, (_, index) => (
                                                                                                <Star
                                                                                                    size={16}
                                                                                                    fill={index > dt?.value - 1 ? "white" : "#FFCC00"}
                                                                                                />
                                                                                            ))}
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            if (dt?.kind === "money") {
                                                                                return (
                                                                                    <div
                                                                                        ...
                                                                                        className={"border-b flex items-center justify-between gap-4"}
                                                                                    >
                                                                                        <MutedParagraph>{dt?.label}</MutedParagraph>
                                                                                        <Paragraph
                                                                                            className={"text-right"}>{dt?.value?.toLocaleString()}</Paragraph>
                                                                                    </div>
                                                                                )
                                                                            }
                                                                            ...
                                                                            return (
                                                                                ...
                                                                                >
                                                                                    <MutedParagraph>{dt?.label}</MutedParagraph>
                                                                                    <Paragraph
                                                                                        className={"text-right"}>{dt?.value}</Paragraph>
                                                                                </div>
                                                                            )
                                                                        })
                                                                    }
                    ...
                    <Sheet>
                        ...
                        >
                                        ...
                                        <CarouselItem key={index}>
                                            <div className="p-1">
                                                <Card className="rounded-md">
                                                    <CardContent
                                                        className="flex w-full h-[50vh] items-center justify-center p-0">
                                                        <img src={image} alt=""
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <Button size="icon" variant={"outline"} disabled={!api?.canScrollPrev()}
                                ...
                                <Button size="icon" variant={"outline"} disabled={!api?.canScrollNext()}
